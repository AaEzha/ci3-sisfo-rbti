               ...
               <div class=" col-md-12" >
                  ...
                  <table class="table table-bordered table-stripped table-hover" >
                     ...
                     <tr>
                        ...
                        <td><?php echo $dp->nama_start_up ?></td>
                        <td width="10px"><?php echo anchor('dosen/daftarproposal/detailproposal/'.$dp->nim_mhs,'<div class="btn btn=sm btn-primary">
                           <i class="fa fa-eye"></i></div>') ?></td>
                           <td width="10px"><?php echo anchor('dosen/daftarproposal/komen/'.$dp->nim_mhs,'<div class="btn btn=sm btn-info">
