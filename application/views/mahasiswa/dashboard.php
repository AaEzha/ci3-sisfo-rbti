            ...
            <div class="row d_flex">
               ...
               <div class="col-md-5">
                  <div class="about_img text_align_center">
                     <figure><img src="<?php echo base_url()?>assets/images/about.png" alt="#"/></figure>
                  </div>
               </div>
            ...
            <div class="row d_flex grid">
               <div class="col-md-7">
                  <div class="coronata_img text_align_center">
                     <figure><img src="<?php echo base_url()?>assets/images/corona.png" alt="#"/></figure>
                  </div>
               </div>
                  ...
                  <div class="owl-carousel owl-theme">
                     <div class="item">
                        <div class="protect_box text_align_center">
                          <div class="desktop">
                             <i><img src="<?php echo base_url()?>assets/images/pro1.png" alt="#"/></i>
                           <h3> Wear Mask</h3>
                     ...
                     <div class="item">
                          <div class="protect_box text_align_center">
                          <div class="desktop">
                             <i><img src="<?php echo base_url()?>assets/images/pro2.png" alt="#"/></i>
                     ...
                     <div class="item">
                         <div class="protect_box text_align_center">
                          <div class="desktop">
                             <i><img src="<?php echo base_url()?>assets/images/pro3.png" alt="#"/></i>
                           <h3> Stay at Home</h3>
                           <span> Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for</span>
                          </div>
                           <a class="read_more" href="protect.html">Read More</a>
            ...
            <div class="row d_flex">
               <div class=" col-md-4">
                  <div class="latest text_align_center">
                     <figure><img src="<?php echo base_url()?>assets/images/cases1.png" alt="#"/></figure>
               ...
               <div class=" col-md-4">
                  <div class="latest text_align_center">
                     <figure><img src="<?php echo base_url()?>assets/images/cases2.png" alt="#"/></figure>
                      <a class="read_more" href="cases.html">Read More</a>
                     <div class="nostrud">
                        <h3>Cases 02</h3>
                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look</p>
               ...
               <div class=" col-md-4">
                  <div class="latest text_align_center">
                     <figure><img src="<?php echo base_url()?>assets/images/cases3.png" alt="#"/></figure>
                      <a class="read_more" href="cases.html">Read More</a>
                     <div class="nostrud">
                        <h3>Cases 03</h3>
                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look</p>
