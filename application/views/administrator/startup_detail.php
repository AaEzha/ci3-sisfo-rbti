<div class="container-fluid">
    ...
    <tr>
                     ...
                     <tr>
                           ...
                           <td><img src="<?php echo base_url().'assets/files/'.$ast->struktur_start_up?>" style="width:20%;"></td>
                          
                     </tr>
                     <tr>
                           <th>LOGO PERUSAHAAN</th>
                           <td><img src="<?php echo base_url().'assets/files/'.$ast->logo_start_up?>" style="width:20%;"></td>
