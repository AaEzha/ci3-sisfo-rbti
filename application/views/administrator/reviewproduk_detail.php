<div class="container-fluid">
    ...
    <?php 
     ...
     <tr>
                     ...
                     <tr>      
                           <th>LOGO APLIKASI</th>
                           <td><img src="<?php echo base_url().'assets/files/'.$arvd->logo_solusi?>"></td>
                       
                     </tr>
                     <tr>
                           <th>PREVIEW UI/UX -1</th>
                           <td><img src="<?php echo base_url().'assets/files/'.$arvd->prev_ui1_solusi?>"></td>
                         

                     </tr>
                     <tr>
                           <th>PREVIEW UI/UX -2</th>
                           <td><img src="<?php echo base_url().'assets/files/'.$arvd->prev_ui2_solusi?>"></td>
                     ...
                     <tr>
                           ...
                           <td><img src="<?php echo base_url().'assets/files/'.$arvd->prev_ui3_solusi?>"></td>
                      

                     </tr>
                     <tr>
                           <th>PREVIEW UI/UX -4</th>
                           <td><img src="<?php echo base_url().'assets/files/'.$arvd->prev_ui4_solusi?>"></td>
